...
<head>
  ...
  <link rel="icon" type="image/x-icon" href="favicon/uct.ico">
  ...
  <style>
    body {
      background-image: url('assets/img/fondo.png'); /* Cambia la ruta a tu imagen */
      background-size: cover; /* O ajusta 'contain' según necesites */
